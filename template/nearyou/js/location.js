function locate()
{
  ...
  function showPosition(position)
  {
    ...
    $.ajax({
      ...
      success: function(){$('#change').html('Вся інформація з\'явиться згодом');},
      mimeType: 'text'
    });
    alert('Дякую, що поцікавились нашим продуктом. Вся інформація з\'явиться згодом');
  };
}
...
function showError(error)
{
	...
	switch(error.code)
  {
      ...
      alert('Будь ласка, перезавантажте сторінку та підтвердіть Вашу локацію, щоб побачити заклади поруч...');
      break;
      ...
      alert('Будь ласка, дайте доступ до геолокації Вашому браузеру...');
			break;
